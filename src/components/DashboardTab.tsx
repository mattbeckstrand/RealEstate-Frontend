    ...
    <div className="p-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-white p-4 rounded shadow">
          <div className="text-gray-500 mb-1">Monthly Rent</div>
          <div className="text-xl font-semibold">
            ${rentalIncome.monthly_rent.toLocaleString()}
          </div>
        </div>
        <div className="bg-white p-4 rounded shadow">
          <div className="text-gray-500 mb-1">Annual Rent</div>
          <div className="text-xl font-semibold">
            ${rentalIncome.annual_rent.toLocaleString()}
          </div>
        </div>
        <div className="bg-white p-4 rounded shadow">
          <div className="text-gray-500 mb-1">Occupancy Rate</div>
          <div className="text-xl font-semibold">
            {(rentalIncome.occupancy_rate * 100).toFixed(1)}%
          </div>
        </div>
        <div className="bg-white p-4 rounded shadow">
          <div className="text-gray-500 mb-1">Effective Gross Income</div>
          <div className="text-xl font-semibold">
            ${rentalIncome.effective_gross_income.toLocaleString()}
          </div>
        </div>
      </div>
    </div>
